...
flags.DEFINE_string("workdir", 'results_outlier', "Working directory ['results']")
...
def main():
    ...
    opts['dataset'] = 'outlier' # gmm, circle_gmm,  mnist, mnist3, cifar ...
    ...
    for step in range(opts["adagan_steps_total"]):
        ...
        more_fake_points = adagan.sample_mixture(5000)
...
if __name__ == '__main__':
    ...
    for _ in tqdm(range()):
        ...
        for i in range(25):                           
            ...
            a = np.load('results_outlier/samples{:02d}.npy'.format(i))                   
            a = a[:, :, 0, 0]                    
